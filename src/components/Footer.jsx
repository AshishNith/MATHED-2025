        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#" className="text-gray-300 hover:text-amber-400 transition-colors">Schedule</a></li>
              <li><a href="#" className="text-gray-300 hover:text-amber-400 transition-colors">Speakers</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-6">
              <a href="#" className="text-gray-300 hover:text-amber-400 transition-colors text-2xl">
